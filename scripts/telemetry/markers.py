...
body. Their zero archived rows are a harvesting gap, not dormancy: the harvester shipped
2026-07-18, after stacking ended (2026-05-29) and PROBABILISTIC_TOOLS_ENABLED went off
(2026-07-11); 137 published comments from that window carry TOOLS_USED=true. Don't read
their absence from the telemetry archive as signal. (The ANCHOR_OVERSHOOT_PP / CLAUSE_PRODUCT_DIVERGENCE_PP
