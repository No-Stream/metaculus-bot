...
| [numeric_pipeline.md](numeric_pipeline.md) | How numeric forecasts turn the declared percentile set into a PCHIP CDF: value extraction, sanitizing, tail widening, min/max-step enforcement, bound pinning, discrete-integer snapping, and the unit-mismatch guard. |
