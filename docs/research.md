...
`details["counts"]` instead of logged, alongside the fired counts. Thirteen keys, and a zero
...
`derived_api_reads`, `wayback_attempts` and `url_context_reads`. Five count rungs that
